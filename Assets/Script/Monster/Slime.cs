...
public class Slime : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        Hp = MonsterManager.inst.Slime_Hp;
        //방향은 0으로 시작 
        Dir = 0;
    }
    ...
    private void OnEnable()
    {
       ...
       gameObject.transform.rotation = Quaternion.Euler(0f, -180f, 0f);
        MonsterManager.inst.Slime_Speed = 3f;
    ...
    public void Down(GameObject Monseter)
    {
        ...
        Monseter.transform.Translate(0, 0, MonsterManager.inst.Slime_Speed * Time.deltaTime);
    ...
    public void Up(GameObject Monseter)
    {
        ...
        healthBar_Rotation.transform.rotation = Quaternion.Euler(0, 0f, 0);
    ...
    public IEnumerator On_KingSkill()
    {
        ...
        MonsterManager.inst.Slime_Speed = 0f;
        yield return new WaitForSeconds(2f);
    ...
    public IEnumerator On_GodSkill()
    {
        while(true)
        {
            KingSkill_prefab.gameObject.SetActive(true);
            QueenSkill_prefab.gameObject.SetActive(true);
            MonsterManager.inst.Slime_Speed = 0.5f;
            
            Debug.Log(MonsterManager.inst.Slime_Speed);
