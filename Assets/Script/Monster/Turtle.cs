...
public class Turtle : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        Hp = MonsterManager.inst.Turtle_Hp;
        //방향은 0으로 시작 
        Dir = 0;
    ...
    private void OnEnable()
    {
        ...
        MonsterManager.inst.Turtle_Speed = 2f;
    ...
    public void Down(GameObject Monseter)
    {
        ...
        Monseter.transform.Translate(0, 0, MonsterManager.inst.Turtle_Speed * Time.deltaTime);
    ...
    public void Left(GameObject Monseter)
    {
        Dir = 3;
        Monseter.transform.rotation = Quaternion.Euler(0, -90f, 0);
        healthBar_Rotation.transform.rotation = Quaternion.Euler(0, 180, 0);
        if (Monseter.transform.position.x <= -9f)
        {
            Dir = 0;
            return;
    ...
    public IEnumerator On_KingSkill()
    {
        ...
        MonsterManager.inst.Turtle_Speed = 0f;
        yield return new WaitForSeconds(2f);
    ...
    public IEnumerator On_GodSkill()
    {
        while (true)
        {
            KingSkill_prefab.gameObject.SetActive(true);
            QueenSkill_prefab.gameObject.SetActive(true);
            MonsterManager.inst.Turtle_Speed = 0.5f;
